...
if CLIENT then
    SWEP.PrintName = "Carte d'identité Suna"
    SWEP.Slot = 2
    SWEP.SlotPos = 2
    SWEP.DrawAmmo = false
...
if CLIENT then
    ...
    hook.Add("PreDrawTranslucentRenderables", "DrawDICardsSuna", function()
        ...
        for k, v in pairs(player.GetAll()) do
            ...
            if v ~= LPlayer and IsValid(CurWep) and v:GetActiveWeapon():GetClass() == "cnsuna" and v:HasWeapon("cnsuna") then
