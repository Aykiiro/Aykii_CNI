...
if CLIENT then
    SWEP.PrintName = "Carte d'identité Konoha"
    SWEP.Slot = 2
    SWEP.SlotPos = 2
    SWEP.DrawAmmo = false
...
if CLIENT then
    ...
    local VUMat = Material("konoha.png")
    ...
    hook.Add("PreDrawTranslucentRenderables", "DrawDICardsKonoha", function()
        ...
        for k, v in pairs(player.GetAll()) do
            ...
            if v ~= LPlayer and IsValid(CurWep) and v:GetActiveWeapon():GetClass() == "cnkonoha" and v:HasWeapon("cnkonoha") then
