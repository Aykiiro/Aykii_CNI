...
if CLIENT then
    SWEP.PrintName = "Carte d'identité Iwa"
    SWEP.Slot = 2
    SWEP.SlotPos = 2
    SWEP.DrawAmmo = false
...
if CLIENT then
    ...
    surface.CreateFont("aykii_font_bis", {
        font = "Roboto",
        size = 20,
        weight = 1500,
        antialias = true
    ...
    surface.CreateFont("aykii_font_yn", {
        font = "Roboto",
        size = 28,
        weight = 1500,
        antialias = true
    ...
    function SWEP:DrawHUD()
        ...
        draw.SimpleText(LP:Nick(), "aykii_font", TextW, TextH + 30, Color(0, 0, 0, 255), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
        draw.SimpleText(LP:SteamID(), "aykii_font", TextW, TextH + 60, Color(0, 0, 0, 255), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
    ...
    hook.Add("PreDrawTranslucentRenderables", "DrawDICardsIwa", function()
        ...
        for k, v in pairs(player.GetAll()) do
            ...
            if v ~= LPlayer and IsValid(CurWep) and v:GetActiveWeapon():GetClass() == "cniwa" and v:HasWeapon("cniwa") then
                ...
                if boneindex then
                    ...
                    local TextW = 105
                    draw.SimpleText(v:Nick(), "aykii_font_bis", TextW, 70, Color(0, 0, 0, 255), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
                    draw.SimpleText(v:SteamID(), "aykii_font_bis", TextW, 90, Color(0, 0, 0, 255), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
